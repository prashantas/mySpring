...
public class TestSpringDeclarativeTransactionsAnnotation {
	private static final String fromAccountNumber = "ACC031";
	private static final String toAccountNumber = "ACC032";
	...
	public static void main(String[] args) {
		...
		AccountService accountService =(AccountService)context.getBean("accountServices");
